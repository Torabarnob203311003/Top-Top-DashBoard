...
function Layout() {
  return (
    <div className="flex min-h-screen">
      {/* Sidebar */}
  <aside className="w-64 bg-[#FEFEFE] border-r border-t border-[#EEEEEE] p-4 flex flex-col">
  ...
  <nav className="flex flex-col gap-6">
      ...
      <div className="flex-1 flex flex-col pb-24">
        {/* Header */}
        <header className="bg-white shadow p-4 flex items-center justify-end pr-10">
          {/* Left: Logo */}
        
          {/* Right: Bell, Profile, Username */}
